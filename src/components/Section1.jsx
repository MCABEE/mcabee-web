  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row pt-[10px] md:pt-[20px] lg:pt-[95px]">
      <div className="w-full lg:w-1/2 flex justify-center flex-col text-center lg:text-left">
        <h1
          className={`${aeonik_regular.className} text-[32px] sm:text-[36px] md:text-[46px] xl:text-[56px] 2xl:text-[64px] text-[#333333] leading-[120%]`}
        >
          Vision. Build. Lead
          <img
        ...
        <p
          className={`${aeonik_light.className} text-sm sm:text-base md:text-lg xl:text-xl 2xl:text-2xl text-[#333333] pt-2 sm:pt-6 px-8 lg:px-0 leading-[140%]`}
        >
        ...
        <div className="flex flex-row items-center justify-center lg:justify-start pt-9 gap-4">
          <div
            className={`${aeonik_regular.className} w-[120px] sm:w-[140px] xl:w-[150px] 2xl:w-[160px] h-[40px] xl:h-[46px] 2xl:h-[56px] border border-[#999999] rounded-[10px] flex justify-center items-center text-sm 2xl:text-base text-[#333333] cursor-pointer hover:bg-[#f5f5f5]`}
          >
            Our Products
          </div>
          <div
