...
const Section4 = () => {
  return (
    <div className="bg-[#87cfeb84] flex justify-center items-center flex-col  py-11 sm:py-10 xl:py-16">
      <p
        className={`${aeonik_regular.className} text-sm md:text-base text-[#666666] pb-3 sm:pb-2 `}
      >
        About us
      </p>
      <h1
        className={`${aeonik_regular.className} text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-[#333333] text-center leading-[120%] `}
      >
      ...
      />
      <p
        className={`${aeonik_light.className} text-sm lg:text-base text-[#333333] px-[17px] sm:px-[10px] md:px-[50px] lg:px-[100px] xl:px-[182px] 2xl:px-[282px] text-center`}
      >
      ...
      <p
        className={`${aeonik_light.className} text-sm lg:text-base text-[#333333] py-3 px-4 sm:px-8 md:px-3 text-center`}
      >
        We create tech-driven solutions that empower individuals and businesses
        globally.
      </p>
      <p
        className={`${aeonik_light.className} text-sm lg:text-base text-[#333333]  px-[20px] md:px-[60px] lg:px-[100px] xl:px-[182px] 2xl:px-[282px] text-center pb-11 md:pb-16`}
      >
