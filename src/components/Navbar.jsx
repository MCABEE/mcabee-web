...
//   const links = [
//     { href: "page_updation_status", label: "Product" },
//     { href: "/", label: "Why us?" },
//     { href: "/", label: "Cases" },
//     { href: "/", label: "About us" },
//     { href: "/", label: "Service" },
...
//           <h1
//             key={item.label}
//             className="text-sm xl:text-base text-[#333333] cursor-pointer hover:text-blue-500"
//           >
//             {item.label}
//           </h1>
//         ))}
...
//       <h1 className="hidden lg:block text-sm xl:text-base text-[#333333] cursor-pointer">
//         English
//       </h1>
...
//               <Image src="/whiteLogo.svg" alt="logo" width={112} height={40} />
//             </Link>
//             <div></div>
//           </div>
//           <hr />
...
const Navbar = () => {
  ...
  const links = [
    { href: "/page_updation_status", label: "Product" },
    { href: "/page_updation_status", label: "Why us?" },
    { href: "/page_updation_status", label: "Cases" },
    { href: "/page_updation_status", label: "About us" },
    { href: "/page_updation_status", label: "Service" },
    { href: "/page_updation_status", label: "Career" },
    { href: "/page_updation_status", label: "Blog" },
    { href: "/page_updation_status", label: "Contact" },
  ];

  return (
    <nav className={`${aeonik_regular.className} w-full px-6 md:px-20 xl:px-36 2xl:px-48 py-6 flex justify-between items-center bg-white shadow-md`}>
      <Link href="/">
        <Image src="/mcabeeLogo.svg" alt="mcabeeLogo" width={112} height={40} />
      </Link>
      ...
      <div className="hidden lg:flex gap-5 xl:gap-10">
        {links.map((item) => (
          <Link key={item.label} href={item.href} className="text-sm xl:text-base text-[#333333] cursor-pointer hover:text-blue-500">
            {item.label}
          </Link>
        ))}
      </div>
